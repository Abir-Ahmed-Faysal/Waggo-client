...
const Home = () => {
  ...
  return (
    <div className="">
      <h1 className="text-center text-yellow-500 text-xs">Flood-related power outage delayed work beyond the deadline </h1>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-100 to-pink-200 dark:from-gray-800 dark:to-gray-900 text-center">
        ...
        <p className="mb-6 text-lg text-gray-700 dark:text-gray-300">
          Your kindness can save lives. Become a hero in a pet’s life by
          adopting today.
        </p>
        <Link to="/pets">
      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            Our goal is to create a bridge between pets and people by making
            adoption accessible, easy, and compassionate. We are a dedicated
            team that believes every animal deserves love, care, and a forever
            home.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Hear heartwarming stories from those who found love and joy through
            adoption. These inspiring stories motivate us to keep going.
          </p>
